        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PreferredTechStack = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAt = table.Column<DateTimeOffset>(nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(nullable: false),
                    AssetTypeId1 = table.Column<Guid>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AssetId = table.Column<Guid>(nullable: false),
                    CanBePublished = table.Column<bool>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PostComments_Assets_AssetId",
                        column: x => x.AssetId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PostAuthors_AssetId",
                table: "PostAuthors",
                column: "AssetId");

            migrationBuilder.CreateIndex(
                name: "IX_PostComments_AssetId",
                table: "PostComments",
                column: "AssetId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_PostAuthors_Assets_AssetId",
                table: "PostAuthors",
                column: "AssetId",
                principalTable: "Assets",
                principalColumn: "Id",
